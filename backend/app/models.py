...
class Zakaznik(db.Model):
    ...
    ucet = db.relationship(
        "VernostniUcet", back_populates="zakaznik", uselist=False)
...
class VernostniUcet(db.Model):
    ...
    id_zakaznika = db.Column(db.Integer, db.ForeignKey(
        "zakaznik.id_zakaznika"), nullable=False)
...
class PolozkaMenu(db.Model):
    ...
    objednavky = db.relationship(
        "PolozkaObjednavky", back_populates="menu_polozka", lazy="dynamic")
    alergeny = db.relationship(
        "PolozkaMenuAlergen", back_populates="menu_polozka", lazy="dynamic")
    plany = db.relationship("PolozkaJidelnihoPlanu",
                            back_populates="menu_polozka", lazy="dynamic")
...
class Alergen(db.Model):
    ...
    polozky = db.relationship("PolozkaMenuAlergen",
                              back_populates="alergen", lazy="dynamic")
...
class Notifikace(db.Model):
    ...
    id_rezervace = db.Column(db.Integer, db.ForeignKey(
        "rezervace.id_rezervace"), nullable=True)
    id_objednavky = db.Column(db.Integer, db.ForeignKey(
        "objednavka.id_objednavky"), nullable=True)
